	...
	if not args.render_only:
		if args.dpi == 'figure':
			...
			try:
				...
				dpi = 'figure'
		if dpi == 'figure':
			savename = os.path.join(args.output_path, f'JOG-2024-0083.Figure3.fdpi.{args.format}')
		else:
			savename = os.path.join(args.output_path, f'JOG-2024-0083.Figure3.{dpi}dpi.{args.format}')
