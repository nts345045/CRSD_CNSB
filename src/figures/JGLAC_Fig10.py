...
:Figure #: 10 (initially submitted as Fig09)
	...
	if not args.render_only:
		if args.dpi == 'figure':
			...
			try:
				...
				dpi = 'figure'
		if dpi == 'figure':
			savename = os.path.join(args.output_path, f'JGLAC_Fig10_fdpi.{args.format}')
		else:
			savename = os.path.join(args.output_path, f'JGLAC_Fig10_{dpi}dpi.{args.format}')
